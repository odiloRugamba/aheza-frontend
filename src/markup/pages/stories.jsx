										...
										<div className="blog-card mb-30">
											...
											<div className="post-info">
												...
												<ul className="post-meta" style={{ justifyContent: 'space-between' }}>
													...
													<Link style={{ background: '#565ACF', color: '#fff', fontSize: 17, fontWeight: 700 }} to={`/${lang}`+ "/story/" + item.title?.replaceAll(" ", "-") + '/' + item?._id} className="btn btn-outline-primary btn-sm">											<FormattedMessage id="ReadMore" defaultMessage="ReadMore" />
 </Link>
												</ul>
