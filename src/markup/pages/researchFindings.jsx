  ...
  return (
   <>
    ...
    <div className="page-content bg-white">
       ...
       <div className="row">
        <div className="col-lg-4 col-md-6 mb-30">
         <div className="feature-container feature-bx2 feature1">
          ...
          <div className="icon-content">
           <h3 className="ttr-title">Depression</h3>
        ...
        <div className="col-lg-4 col-md-6 mb-30">
         <div className="feature-container feature-bx2 feature2">
          ...
          <div className="icon-content">
           <h3 className="ttr-title">Anxiety disorders</h3>
           <p>Phasellus venenatis porta rhoncus. Integer et viverra felis.</p>
           <Link to="/service-detail" className="btn btn-primary light">View More</Link>
          </div>
         </div>
        ...
        <div className="col-lg-4 col-md-6 mb-30">
         <div className="feature-container feature-bx2 feature3">
          ...
          <div className="icon-content">
           <h3 className="ttr-title">Schizophrenia</h3>
           <p>Phasellus venenatis porta rhoncus. Integer et viverra felis.</p>
           <Link to="/service-detail" className="btn btn-primary light">View More</Link>
          </div>
         </div>
        ...
        <div className="col-lg-4 col-md-6 mb-30">
         <div className="feature-container feature-bx2 feature2">
          ...
          <div className="icon-content">
           <h3 className="ttr-title">	Bipolar disorder</h3>
           <p>Phasellus venenatis porta rhoncus. Integer et viverra felis.</p>
           <p>Phasellus venenatis porta rhoncus. Integer et viverra felis.</p>
           <Link to="/service-detail" className="btn btn-primary light">View More</Link>
          </div>
        ...
        <div className="col-lg-4 col-md-6 mb-30">
         <div className="feature-container feature-bx2 feature3">
          ...
          <div className="icon-content">
           <h3 className="ttr-title">Post-traumatic stress disorder (PTSD)</h3>
           <p>Phasellus venenatis porta rhoncus. Integer et viverra felis.</p>
           <Link to="/service-detail" className="btn btn-primary light">View More</Link>
          </div>
         </div>
        ...
        <div className="col-lg-4 col-md-6 mb-30">
         <div className="feature-container feature-bx2 feature1">
          ...
          <div className="icon-content">
           <h3 className="ttr-title">Obsessive-compulsive disorder (OCD)</h3>
           <p>Phasellus venenatis porta rhoncus. Integer et viverra felis.</p>
           <Link to="/service-detail" className="btn btn-primary light">View More</Link>
          </div>
         </div>
     ...
     <LatestNewsSection title="Research News" />
